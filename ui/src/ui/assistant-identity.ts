...
/** Fallback text avatar for assistants without a configured avatar. */
export const DEFAULT_ASSISTANT_AVATAR = "A";

/** Display identity for the active assistant/agent. */
...
/** Normalize assistant identity fields before storing or rendering them. */
