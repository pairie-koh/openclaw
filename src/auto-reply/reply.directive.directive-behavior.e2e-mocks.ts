...
/** Hoisted compaction mock used by directive behavior tests. */
export const compactEmbeddedAgentSessionMock: Mock = vi.fn();
/** Hoisted model-catalog mock used by directive behavior tests. */
export const loadModelCatalogMock: Mock = vi.fn();
/** Hoisted command-secret resolution mock used by directive behavior tests. */
export const resolveCommandSecretRefsViaGatewayMock: Mock = vi.fn();
/** Hoisted auth-profile override clear mock used by directive behavior tests. */
export const clearSessionAuthProfileOverrideMock: Mock = vi.fn();
/** Hoisted auth-profile override resolver mock used by directive behavior tests. */
...
/** Runs the mocked reply agent and normalizes directive reply metadata. */
...
/** Reply-agent mock wired to directive behavior normalization. */
export const runReplyAgentMock: Mock = vi.fn(runDirectiveBehaviorReplyAgent);

/** Runs the prepared-reply mock with provider/model/reasoning params extracted. */
...
/** Prepared-reply mock wired to directive behavior normalization. */
