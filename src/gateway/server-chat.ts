...
/** Broadcast function used for gateway-wide chat events. */
...
/** Function used to emit node events to one session. */
...
/** Dependencies needed to project agent events into chat/session subscribers. */
...
/** Create the runtime agent-event handler used by gateway chat surfaces. */
