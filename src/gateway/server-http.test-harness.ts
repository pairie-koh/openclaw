...
/** Resolved no-auth gateway fixture for HTTP server tests. */
...
/** Resolved token-auth gateway fixture for HTTP server tests. */
...
/** Emits a request against the test server and waits for response completion. */
...
/** Runs a test with a temporary gateway config root and trusted-proxy baseline. */
...
/** Runs a callback with a temporary configured gateway HTTP server. */
...
/** Asserts that a captured gateway response is a 401 Unauthorized body. */
...
/** Creates a channel handler that only accepts the canonicalized profile route. */
...
/** Canonical path variants expected to fail without authorization. */
...
/** Canonical path variants expected to route after authorization. */
...
/** Asserts every route variant is rejected without auth. */
...
/** Asserts every authorized route variant reaches the canonical channel handler. */
