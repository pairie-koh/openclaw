// Builds lazy native approval runtime adapters for channel plugins.
...
/** Context capability key used for native channel approval runtimes. */
export const CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY = "approval.native";

/** Creates a native approval adapter that loads its heavy runtime on first use. */
