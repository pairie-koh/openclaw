// plugins installed plugin index types helpers and runtime behavior.
...
/** Reused constant for INSTALLED PLUGIN INDEX VERSION behavior in src/plugins. */
export const INSTALLED_PLUGIN_INDEX_VERSION = 1;
/** Reused constant for INSTALLED PLUGIN INDEX MIGRATION VERSION behavior in src/plugins. */
export const INSTALLED_PLUGIN_INDEX_MIGRATION_VERSION = 1;
/** Reused constant for INSTALLED PLUGIN INDEX WARNING behavior in src/plugins. */
...
/** Shared type for Installed Plugin Index Refresh Reason in src/plugins. */
...
/** Shared type for Installed Plugin Startup Info in src/plugins. */
...
/** Shared type for Installed Plugin Install Record Info in src/plugins. */
...
/** Shared type for Installed Plugin Package Channel Info in src/plugins. */
export type InstalledPluginPackageChannelInfo = PluginPackageChannel;

/** Shared type for Installed Plugin Index Record in src/plugins. */
...
/** Shared type for Installed Plugin Index in src/plugins. */
...
/** Shared type for Load Installed Plugin Index Params in src/plugins. */
...
/** Shared type for Refresh Installed Plugin Index Params in src/plugins. */
