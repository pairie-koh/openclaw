...
/** Quote unsafe integer literals before JSON.parse can lose precision. */
...
/** Parse JSON while preserving unsafe integer literals as strings. */
...
/** Parse a JSON object while preserving unsafe integer literals as strings. */
