...
/** Sanitization mode for provider-specific tool call id constraints. */
...
/** Extract provider tool-call ids from assistant content blocks. */
...
/** Extract the first tool result id from a tool result message. */
...
/** Extract all known provider-specific tool result id aliases from a message. */
...
/** Validate tool ids against Cloud Code Assist replay constraints. */
