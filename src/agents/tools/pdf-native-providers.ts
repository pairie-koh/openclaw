...
/** Submit PDFs through Anthropic's native document blocks and return text output. */
...
/** Submit PDFs through Gemini generateContent inline data and return text output. */
