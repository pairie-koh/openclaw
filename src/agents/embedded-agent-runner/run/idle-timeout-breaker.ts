...
/** Mutable counter for idle timeouts that occurred before completed output. */
...
/** Latest attempt outcome consumed by the idle-timeout breaker. */
...
/** Breaker counter and trip state after one attempt outcome. */
