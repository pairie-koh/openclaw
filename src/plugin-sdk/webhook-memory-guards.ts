...
/** In-memory fixed-window limiter for per-key webhook traffic. */
...
/** Bounded in-memory counter with optional TTL pruning. */
...
/** Defaults for webhook rate limiting memory and window size. */
...
/** Defaults for sampled webhook anomaly counters. */
...
/** HTTP statuses counted by the default webhook anomaly tracker. */
export const WEBHOOK_ANOMALY_STATUS_CODES = Object.freeze([400, 401, 408, 413, 415, 429]);

/** Tracks repeated webhook failures and emits sampled anomaly logs. */
