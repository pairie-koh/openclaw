...
/** Register emoji listing and upload commands for channels that support custom emoji. */
...
/** Register sticker send/upload commands with channel target and media options. */
