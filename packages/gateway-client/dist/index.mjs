import { DEFAULT_PREAUTH_HANDSHAKE_TIMEOUT_MS, MAX_CONNECT_CHALLENGE_TIMEOUT_MS, MAX_SAFE_TIMEOUT_DELAY_MS, MIN_CONNECT_CHALLENGE_TIMEOUT_MS, clampConnectChallengeTimeoutMs, getConnectChallengeTimeoutMsFromEnv, getPreauthHandshakeTimeoutMsFromEnv, resolveConnectChallengeTimeoutMs, resolveFiniteTimeoutDelayMs, resolvePreauthHandshakeTimeoutMs, resolveSafeTimeoutDelayMs } from "./timeouts.mjs";
import { n as waitForEventLoopReady, t as startGatewayClientWhenEventLoopReady } from "./readiness-DIrwMTRN.mjs";
...
function parseGatewayIpAddress(host) {
	...
	if (ipaddr.IPv4.isValid(normalized) && !ipaddr.IPv4.isValidFourPartDecimal(normalized)) return null;
...
//#endregion
export { DEFAULT_PREAUTH_HANDSHAKE_TIMEOUT_MS, GATEWAY_CLOSE_CODE_HINTS, GatewayClient, GatewayClientRequestError, MAX_CONNECT_CHALLENGE_TIMEOUT_MS, MAX_SAFE_TIMEOUT_DELAY_MS, MIN_CONNECT_CHALLENGE_TIMEOUT_MS, buildDeviceAuthPayload, buildDeviceAuthPayloadV3, clampConnectChallengeTimeoutMs, describeGatewayCloseCode, getConnectChallengeTimeoutMsFromEnv, getPreauthHandshakeTimeoutMsFromEnv, isGatewayConnectAssemblyError, normalizeDeviceMetadataForAuth, resolveConnectChallengeTimeoutMs, resolveFiniteTimeoutDelayMs, resolveGatewayClientConnectChallengeTimeoutMs, resolvePreauthHandshakeTimeoutMs, resolveSafeTimeoutDelayMs, startGatewayClientWhenEventLoopReady, waitForEventLoopReady };
