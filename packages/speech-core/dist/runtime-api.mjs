import { canonicalizeSpeechProviderId, getSpeechProvider, listSpeechProviders, normalizeSpeechProviderId, normalizeTtsAutoMode, parseTtsDirectives, resolveEffectiveTtsConfig, scheduleCleanup, summarizeText } from "./api.mjs";
import { withSpeakerSelectionCompat } from "./speaker.mjs";
import { resolvePrimaryVoiceProviderCandidate, resolveSupportedVoiceModelRefs, resolveVoiceModelRefs, resolveVoiceProviderCandidates, voiceProviderSupportsModel } from "./voice-models.mjs";
...
import { markReplyPayloadAsTtsSupplement, resolveSendableOutboundReplyParts } from "openclaw/plugin-sdk/reply-payload";
...
import { resolvePreferredOpenClawTmpDir, tempWorkspaceSync } from "openclaw/plugin-sdk/sandbox";
