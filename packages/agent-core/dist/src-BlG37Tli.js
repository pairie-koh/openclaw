...
import "./agent.js";
import { ExecutionError, FileError, err, ok, toError } from "./harness/types.js";
import { killProcessTree } from "./harness/env/kill-tree.js";
import "./harness/prompt-templates.js";
import "./harness/skills.js";
import "./harness/agent-harness.js";
import "./harness/utils/truncate.js";
import "./harness/utils/shell-output.js";
...
var NodeExecutionEnv = class {
	...
	async exec(command, options) {
		...
		return await new Promise((resolvePromise) => {
			...
			timeoutId = typeof options?.timeout === "number" ? setTimeout(() => {
				timedOut = true;
				if (child?.pid) killProcessTree(child.pid, { force: true });
			}, options.timeout * 1e3) : void 0;
