// Bounded response body readers for remote memory HTTP errors and JSON parsing.
...
/** Reads a small collapsed text prefix for diagnostics without buffering large bodies. */
...
/** Reads and parses JSON only when headers and streamed bytes stay within the limit. */
